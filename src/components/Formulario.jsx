...
const Formulario = ({cliente,cargando}) => {
    ...
    const nuevoClienteSchema = Yup.object().shape({
        nombre: Yup.string()
                    ...
                    .required("el campo de nombre es obligtorio"),

        empresa: Yup.string()
                    .required("El campo de empresa es obligatorio"),
        email: Yup.string()
                   .email("email no valido")
                   .required("el campo de e-mail es obligatorio"),
        telefono: Yup.number()
                     .positive("imgrece un telefono valido")
                     .integer("ingrece un telefono valido")
                     .typeError("ingrece un telefono valido")
